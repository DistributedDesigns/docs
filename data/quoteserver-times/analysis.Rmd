...
h$density = h$density * 1e3 # change densities to percents
plot(h,
     freq = F,
     col = "lightgreen",
     ylim = range(0:1),
...
Choosing an initial response timeout of 20 milliseconds and 5 millisecond exponential backoff requires 4 iterations to exceed the expected delay. This event has a likelihood of 1.3761%. Exceeding 1 second total delay has a likelihood of 0.2545%
